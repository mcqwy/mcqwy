...
import com.mon_lh.mcqwy.inventory.ContainerRepairI;
...
public class GuiRepairI extends GuiContainer
{
	private static final String TEXTURE_PATH = Mcqwy.MODID + ":" + "textures/gui/container/gui_repair.png";
    private static final ResourceLocation TEXTURE = new ResourceLocation(TEXTURE_PATH);

    protected ContainerRepairI inventory;

    private int totalBurnTime;

    public GuiRepairI(ContainerRepairI inventorySlotsIn)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.drawTexturedModalRect(offsetX + 78, offsetY + 30, 0, 156, textureWidth, 17);
    }
    
    @Override
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
    	String title = I18n.format("container.mcqwy.repair");
