...
public class BlockReform extends BlockContainer
{
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tile instanceof TileEntityReform)
        {
        ...
        Block.spawnAsEntity(worldIn, pos, new ItemStack(BlockLoader.reform));
